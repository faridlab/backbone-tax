//! WithholdingCategory REST handlers
//!
...
pub enum WithholdingCategoryError {
    #[error("Not found: {0}")]
    NotFound(String),
...
impl From<ServiceError> for WithholdingCategoryError {
...
impl axum::response::IntoResponse for WithholdingCategoryError {
...
/// Create Axum router with all 16 Backbone endpoints for WithholdingCategory.
///
/// # Routes
///
/// | Method | Path | Description |
/// |--------|------|-------------|
/// | GET | /withholding_categories | List with pagination |
/// | POST | /withholding_categories | Create new |
/// | GET | /withholding_categories/:id | Get by ID |
/// | PUT | /withholding_categories/:id | Full update |
/// | PATCH | /withholding_categories/:id | Partial update |
/// | DELETE | /withholding_categories/:id | Soft delete |
/// | POST | /withholding_categories/bulk | Bulk create |
/// | POST | /withholding_categories/upsert | Upsert |
/// | GET | /withholding_categories/trash | List deleted |
/// | POST | /withholding_categories/:id/restore | Restore |
/// | DELETE | /withholding_categories/empty | Empty trash |
/// | GET | /withholding_categories/:id/deleted | Get deleted by ID |
/// | DELETE | /withholding_categories/trash/:id | Permanent delete from trash |
/// | GET | /withholding_categories/count | Count active entities |
/// | GET | /withholding_categories/trash/count | Count deleted entities |
///
/// # Example
///
/// ```text
/// let service = Arc::new(WithholdingCategoryService::with_repository(repository));
...
#[cfg(feature = "auth")]
pub fn create_protected_withholding_category_routes<A: AuthMiddleware + Send + Sync + 'static>(
