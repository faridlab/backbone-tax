//! TaxCategory DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new TaxCategory
///
...
/// Request DTO for full update of a TaxCategory
///
...
/// Request DTO for partial update of a TaxCategory
///
...
pub struct PatchTaxCategoryDto {
    ...
    #[serde(skip_serializing_if = "Option::is_none", alias = "tax_kind")]
...
/// Response DTO for TaxCategory entity
///
...
/// Paginated list response for TaxCategory entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct TaxCategoryListResponseDto {
    /// List of items
    pub items: Vec<TaxCategoryResponseDto>,
...
impl TaxCategoryListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<TaxCategoryResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<TaxCategory> for TaxCategoryResponseDto {
...
impl From<TaxCategory> for TaxCategorySummaryDto {
    fn from(entity: TaxCategory) -> Self {
...
impl From<CreateTaxCategoryDto> for TaxCategory {
...
impl backbone_core::FromCreateDto<CreateTaxCategoryDto> for TaxCategory {
    fn from_create_dto(dto: CreateTaxCategoryDto) -> backbone_core::ServiceResult<Self> {
        Ok(TaxCategory::from(dto))
    }
}
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to TaxCategory here.
