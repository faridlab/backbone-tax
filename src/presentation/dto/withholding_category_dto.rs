//! WithholdingCategory DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new WithholdingCategory
///
...
/// Request DTO for full update of a WithholdingCategory
///
...
/// Request DTO for partial update of a WithholdingCategory
///
...
pub struct PatchWithholdingCategoryDto {
    ...
    #[serde(skip_serializing_if = "Option::is_none", alias = "threshold_amount")]
...
impl PatchWithholdingCategoryDto {
    ...
    pub fn has_changes(&self) -> bool {
        self.company_id.is_some() || self.code.is_some() || self.name.is_some() || self.rate.is_some() || self.threshold_amount.is_some() || self.account_id.is_some() || self.effective_from.is_some() || self.effective_to.is_some() || self.status.is_some()
    }
}
...
/// Response DTO for WithholdingCategory entity
///
...
/// Paginated list response for WithholdingCategory entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct WithholdingCategoryListResponseDto {
    /// List of items
    pub items: Vec<WithholdingCategoryResponseDto>,
...
impl From<WithholdingCategory> for WithholdingCategoryResponseDto {
    fn from(entity: WithholdingCategory) -> Self {
        Self {
            ...
            name: entity.name,
            rate: entity.rate,
            threshold_amount: entity.threshold_amount,
...
impl From<WithholdingCategory> for WithholdingCategorySummaryDto {
    fn from(entity: WithholdingCategory) -> Self {
...
impl From<CreateWithholdingCategoryDto> for WithholdingCategory {
...
impl From<&WithholdingCategory> for WithholdingCategoryResponseDto {
    fn from(entity: &WithholdingCategory) -> Self {
        Self {
            ...
            threshold_amount: entity.threshold_amount.clone(),
...
impl backbone_core::FromCreateDto<CreateWithholdingCategoryDto> for WithholdingCategory {
    fn from_create_dto(dto: CreateWithholdingCategoryDto) -> backbone_core::ServiceResult<Self> {
        Ok(WithholdingCategory::from(dto))
    }
}
...
impl backbone_core::ApplyUpdateDto<UpdateWithholdingCategoryDto> for WithholdingCategory {
    fn apply_update(mut self, dto: UpdateWithholdingCategoryDto) -> backbone_core::ServiceResult<Self> {
        ...
        self.name = dto.name;
        self.rate = dto.rate;
        self.threshold_amount = dto.threshold_amount;
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to WithholdingCategory here.
