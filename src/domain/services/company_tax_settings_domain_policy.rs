//! Domain policy for CompanyTaxSettings aggregate
//!
...
/// Domain policy for CompanyTaxSettings — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<CompanyTaxSettings>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type CompanyTaxSettingsDomainPolicy = PermitAllPolicy<CompanyTaxSettings>;
