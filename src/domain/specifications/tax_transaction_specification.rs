//! Specifications for TaxTransaction aggregate
//!
...
// Each predicate implements `Specification<TaxTransaction>` and can be combined
...
//
// pub struct ActiveTaxTransactionSpec;
// impl Specification<TaxTransaction> for ActiveTaxTransactionSpec {
//     fn is_satisfied_by(&self, e: &TaxTransaction) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
