//! Specifications for CompanyTaxSettings aggregate
//!
...
// Each predicate implements `Specification<CompanyTaxSettings>` and can be combined
...
//
// pub struct ActiveCompanyTaxSettingsSpec;
// impl Specification<CompanyTaxSettings> for ActiveCompanyTaxSettingsSpec {
//     fn is_satisfied_by(&self, e: &CompanyTaxSettings) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
