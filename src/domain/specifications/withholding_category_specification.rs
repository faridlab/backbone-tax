//! Specifications for WithholdingCategory aggregate
//!
...
// Each predicate implements `Specification<WithholdingCategory>` and can be combined
...
//
// pub struct ActiveWithholdingCategorySpec;
// impl Specification<WithholdingCategory> for ActiveWithholdingCategorySpec {
//     fn is_satisfied_by(&self, e: &WithholdingCategory) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
