//! Specifications for TaxFilingPeriod aggregate
//!
...
// Each predicate implements `Specification<TaxFilingPeriod>` and can be combined
...
//
// pub struct ActiveTaxFilingPeriodSpec;
// impl Specification<TaxFilingPeriod> for ActiveTaxFilingPeriodSpec {
//     fn is_satisfied_by(&self, e: &TaxFilingPeriod) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
