...
--
-- This file contains initial seed data for the tax.tax_tags table.
-- Customize this file to add your initial data.

-- INSERT INTO tax.tax_tags (
--     id,
--     company_id,
--     code,
--     name,
...
-- INSERT INTO tax.tax_tags (id, code, name, is_active, created_at, updated_at) VALUES
